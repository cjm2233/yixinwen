...
public class SecienceFragment extends Fragment {
    private View view;
        ...
        observable.subscribeOn(Schedulers.io())
                ...
                .subscribe(new Observer<News>() {
                    ...
                    public void onNext(News value) {
                        Log.i("0000", value.toString());
                        Log.i("9999", value.getTitle());
                        Log.i("1111", value.getTime() + "");
                        Log.i("2222", value.getSource());
                        Log.i("3333", value.getText());
                        News news = new News();
